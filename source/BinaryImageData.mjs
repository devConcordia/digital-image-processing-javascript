 ...
 *	
 */
export default class BinaryImageData extends Uint8Array {
	...
	clone() {
		...
		return new BinaryImageData( this.width, this.height, this ); 
	...
	erode( matrix ) {
		...
		const output = new BinaryImageData( w, h );
